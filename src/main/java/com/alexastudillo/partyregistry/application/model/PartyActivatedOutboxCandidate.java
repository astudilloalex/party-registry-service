...
/**
 * Carries the minimal safe data for a version-one Party-activated event.
 */
public record PartyActivatedOutboxCandidate(
        UUID eventId,
        TenantId tenantId,
        PartyId partyId,
    ...
    public static final String EVENT_TYPE = "party.activated.v1";

    public PartyActivatedOutboxCandidate {
