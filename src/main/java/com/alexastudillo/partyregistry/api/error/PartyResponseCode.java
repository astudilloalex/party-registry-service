...
public enum PartyResponseCode implements ApiResponseCode {
    ...
    LEGAL_ENTITY_NOT_FOUND("legal-entity-not-found", 404),
    ...
    IDENTIFIER_UNIQUENESS_CONFLICT("identifier-uniqueness-conflict", 409),
    IDENTIFIER_VALIDATION_FAILURE("identifier-validation-failure", 422),
    INVALID_PARTY_LIFECYCLE("invalid-party-lifecycle", 409),
    MISSING_QUALIFYING_IDENTIFIER("missing-qualifying-identifier", 422),
    BLANK_DISPLAY_NAME("blank-display-name", 422),
    BIRTH_DATE_IN_FUTURE("birth-date-in-future", 422),
    DATE_OF_DEATH_IN_FUTURE("date-of-death-in-future", 422),
    DEATH_BEFORE_BIRTH("death-before-birth", 422),
    INCORPORATION_DATE_IN_FUTURE("incorporation-date-in-future", 422),
    DISSOLUTION_DATE_IN_FUTURE("dissolution-date-in-future", 422),
    DISSOLUTION_BEFORE_INCORPORATION("dissolution-before-incorporation", 422),
